...
function update(client, guildId, newPrefix) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            client.temp.guilds.set(guildId, Object.assign(Object.assign({}, guildInfo), { prefix: newPrefix }));
        }
        catch (error) {
            return {
                success: false,
